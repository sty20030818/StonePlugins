...
const PROMPT_REMINDER = "Stonefish Engineering 仍然生效：工程任务应加载 $stonefish-engineering；项目明确约束优先，选择最小完整、长期连贯且可验证的方案。";
...
async function readCoreContext(env) {
    ...
    const skillPath = path.join(pluginRoot, "skills", "stonefish-engineering", "SKILL.md");
